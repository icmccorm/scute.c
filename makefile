...
EM_JS_FLAGS = $(EM_JS_EXPORTS) -s ASSERTIONS=1 -s SAFE_HEAP=1 -s WASM=1 -s MODULARIZE=1 -s STRICT=1 -s FILESYSTEM=0 -s EXPORT_ES6=1 -s USE_ES6_IMPORT_META=0 -s ENVIRONMENT='worker' -s EXPORT_NAME="'Scute'"
